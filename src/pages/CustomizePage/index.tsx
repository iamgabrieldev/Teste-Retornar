...
const CustomizePage: React.FC<CustomizePageProps> = ({adicionais, handleAdicional}) => {
    ...
    return (
        <>
            <div style={{backgroundColor: '#fff', width: '30vw', height: '24vh', margin: '25vh auto',borderRadius: '8px', padding: '32px 64px'}}>
                <h1 style={{fontSize: '30px',color: '#46295A', textAlign: 'center'}} >Personalize seu açaí</h1>
                <h2 style={{color: '#46295A', marginBottom: '0px'}} >Personalização:</h2>
                <div style={{display: 'flex'}}>
                    {
                        adicionais && adicionais.map((adicional:any, index:any) => <Card
