  ...
  return (
    <>
      ...
      >
        ...
        <h2 style={{ fontSize: "22px", color: "#46295A", marginBottom: "0px" }}>
          Tamanho:
        </h2>
        <div>
          <p>-{tamanho.nome}</p>
        ...
        <h3 style={{ color: "#46295A", fontSize: "16px" }}>
          <strong>Valor total:</strong>
          {(tamanho.preco + sabor.preco + adicional.preco).toFixed(2)}
        </h3>
        <h3 style={{ color: "#46295A", fontSize: "16px" }}>
          <strong>Tempo de Preparo:</strong>
          {tamanho.tempo + sabor.tempo + adicional.tempo}
        </h3>
